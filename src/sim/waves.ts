...
export const WAVES: Wave[] = [
  ...
  { groups: [g('sam', 8, 40), g('gang', 4, 110, 200)], scale: 1.1 },
  ...
  { groups: [g('ben', 2, 220), g('mike', 3, 140, 180)], scale: 1.15 },
  ...
  { groups: [g('gang', 6, 90), g('mike', 4, 140, 240)], scale: 1.35 },
  ...
  {
    groups: [g('mike', 8, 90), g('ben', 4, 170, 120), g('tina', 3, 200, 200), g('gang', 6, 85, 300)],
    scale: 1.9,
  },
];
